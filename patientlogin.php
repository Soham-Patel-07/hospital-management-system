...
{
	$sql = "SELECT * FROM patient WHERE email='$_POST[loginid]' AND password='$_POST[password]' AND status='Active'";
    ...
    <table width="200" border="3">
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="email" name="loginid" id="loginid" /></td>
        </tr>
        <tr>
          <td>Password</td>
