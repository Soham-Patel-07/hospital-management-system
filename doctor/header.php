...
<center><a href="index.php"><h1>Cell Oasis</h1></a></center>
  ...
  <li>
    <a href="../index.php" 
        ...
        " 
        onmouseover="this.style.background='linear-gradient(45deg, #16a085, #1abc9c)'; this.style.transform='scale(1.1)'; this.style.boxShadow='0 6px 10px rgba(0, 0, 0, 0.2)';" 
        ...
        onmousedown="this.style.background='#0e6655'; this.style.transform='scale(1.05)';"
        onmouseup="this.style.background='linear-gradient(45deg, #16a085, #1abc9c)';">
        Home
    </a>
</li>
    </ul>
